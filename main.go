...
func gen(es []*ca) (err error) {
	s := ""
	s += "// generated by lazy, DO NOT EDIT.\n\n"
	s += "package main\n\n"
	s += "import \"net/http\"\n"
	s += "import \"time\"\n"
	...
	s += "}"
	ioutil.WriteFile("LAZY.go", []byte(s), 0644)
	return
}
...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Fprintf(os.Stderr, "version: 1.0, Created by KOFLAzycat [7/2017]\n\n")
